...
for line in data:
	...
	try:
		...
		## inicio prueba
		local_media_1 += int(local_line[1])
		local_media_2 += int(local_line[2])
		local_media_3 += int(local_line[3])
		date = local_line[0]
		## fin prueba
		...
		if(i >= media_range):
			i = 0
			media_file_10000.write( date + "," + str(local_media_1/media_range) + "," + str(local_media_2/media_range) + "," + str(local_media_3/media_range) + "\n" )
			local_media_1 = 0
			local_media_2 = 0
			local_media_3 = 0
